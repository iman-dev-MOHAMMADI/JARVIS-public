/**
 * JARVIS v3 - Secretary تیم MOHAMMADI با سیستم نقش‌ها، پروفایل استاندارد و فرم‌های هوشمند
 * - نقش‌ها: مردم عادی / کارفرما / عضو جدید
 * - پروفایل 4 بخشی: درباره من، مهارت‌ها، تجربه کاری، تحصیلات
 * - فرم عضویت و درخواست پروژه -> ارسال به ادمین 8752475468
 * - فکر 4 مرحله‌ای + گارد + دیزاین HTML + انیمیشن Edit
 */
